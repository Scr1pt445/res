...
var SetupAdminModal = class extends import_obsidian2.Modal {
  ...
  onOpen() {
    ...
    let password = "";
    let repeat = "";
    new import_obsidian2.Setting(sWrap).setName("Email").addText((t) => {
      t.setPlaceholder("admin@company.com");
      t.inputEl.type = "email";
      t.onChange((v) => email = v.trim());
    });
    new import_obsidian2.Setting(sWrap).setName("\u041F\u0430\u0440\u043E\u043B\u044C").addText((t) => {
      t.setPlaceholder("\u043F\u0430\u0440\u043E\u043B\u044C");
      t.inputEl.type = "password";
      t.onChange((v) => password = v);
    });
    new import_obsidian2.Setting(sWrap).setName("\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u0435 \u043F\u0430\u0440\u043E\u043B\u044C").addText((t) => {
    ...
    let gitBranch = "main";
    let gitAuthToken = "";
    new import_obsidian2.Setting(sWrap).setName("Git URL (\u043F\u043E \u0436\u0435\u043B\u0430\u043D\u0438\u044E)").addText((t) => {
      t.setPlaceholder("https://github.com/...").onChange((v) => gitRepoUrl = v.trim());
    });
    new import_obsidian2.Setting(sWrap).setName("Git \u0432\u0435\u0442\u043A\u0430").addText((t) => {
      t.setPlaceholder("main").setValue("main").onChange((v) => gitBranch = v.trim());
    });
    new import_obsidian2.Setting(sWrap).setName("Git \u0442\u043E\u043A\u0435\u043D (\u043F\u043E \u0436\u0435\u043B\u0430\u043D\u0438\u044E)").addText((t) => {
      t.setPlaceholder("ghp_...").onChange((v) => gitAuthToken = v.trim());
    });
    new import_obsidian2.Setting(sWrap).addButton(
      (btn) => btn.setButtonText("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0430\u0434\u043C\u0438\u043D\u0438\u0441\u0442\u0440\u0430\u0442\u043E\u0440\u0430").setCta().onClick(async () => {
        if (!email || !password || !repeat) {
          new import_obsidian2.Notice("\u0417\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u0435 \u0432\u0441\u0435 \u043F\u043E\u043B\u044F.");
          return;
        }
        if (!email.includes("@") || email.length < 4) {
          new import_obsidian2.Notice("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u044B\u0439 email.");
          return;
        }
        if (password.length < 4) {
          new import_obsidian2.Notice("\u041F\u0430\u0440\u043E\u043B\u044C \u0441\u043B\u0438\u0448\u043A\u043E\u043C \u043A\u043E\u0440\u043E\u0442\u043A\u0438\u0439.");
          return;
        }
        if (password !== repeat) {
          new import_obsidian2.Notice("\u041F\u0430\u0440\u043E\u043B\u0438 \u043D\u0435 \u0441\u043E\u0432\u043F\u0430\u0434\u0430\u044E\u0442.");
          return;
        }
        const access = await this.plugin.loadAccessJson();
        if (access.users.length > 0) {
          new import_obsidian2.Notice("\u0410\u0434\u043C\u0438\u043D\u0438\u0441\u0442\u0440\u0430\u0442\u043E\u0440 \u0443\u0436\u0435 \u0441\u043E\u0437\u0434\u0430\u043D.");
          this.close();
          return;
        }
        const admin = {
        ...
        new import_obsidian2.Notice("\u0410\u0434\u043C\u0438\u043D\u0438\u0441\u0442\u0440\u0430\u0442\u043E\u0440 \u0441\u043E\u0437\u0434\u0430\u043D!");
        this.close();
...
var LoginModal = class extends import_obsidian3.Modal {
  constructor(app, plugin) {
    super(app);
    this.plugin = plugin;
  }
  onOpen() {
    ...
    loginBtn.onclick = async () => {
      try {
        ...
        if (!user) {
          new import_obsidian3.Notice("\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u043B\u043E\u0433\u0438\u043D \u0438\u043B\u0438 \u043F\u0430\u0440\u043E\u043B\u044C");
          return;
        }
        this.plugin.settings.currentUser = user;
        await this.plugin.saveSettings();
        new import_obsidian3.Notice(`\u0412\u044B \u0432\u043E\u0448\u043B\u0438 \u043A\u0430\u043A ${user.email} (${user.role})`);
        this.close();
        if (user.role === "admin")
          this.plugin.openAdminView();
        else
        ...
        new import_obsidian3.Notice("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0432\u0445\u043E\u0434\u0435: " + (e?.message || e));
...
var AdminView = class extends import_obsidian4.ItemView {
  ...
  async onOpen() {
    ...
    if (!document.getElementById("access-tree-style")) {
      const style = document.createElement("style");
      style.id = "access-tree-style";
      style.innerHTML = `
        .access-tree-row {
          margin-bottom: 2px;
          padding: 1px 0 1px 0;
        ...
        .adminview-h2 { font-size: 1.7em; margin-top:28px; }
        .adminview-btn-red { background:#fd3e50;color:#fff; }
        .adminview-btn-red:hover { filter: brightness(1.10);}
      `;
    ...
    new import_obsidian4.Setting(containerEl).addButton(
      (btn) => btn.setButtonText("\u0412\u044B\u0439\u0442\u0438").setWarning().onClick(async () => {
        ...
        await this.plugin.saveSettings();
        new import_obsidian4.Notice("\u0412\u044B \u0432\u044B\u0448\u043B\u0438 \u0438\u0437 \u0441\u0438\u0441\u0442\u0435\u043C\u044B");
    ...
    access.users.forEach((u) => {
      new import_obsidian4.Setting(usersBox).setClass("access-admin-user-row").addText((t) => {
        t.setValue(u.email);
        t.setDisabled(true);
      }).addText((t) => {
        ...
        t.onChange(async (v) => {
          u.password = v;
          await this.plugin.saveAccessJson(access);
          new import_obsidian4.Notice(`\u041F\u0430\u0440\u043E\u043B\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0451\u043D \u0434\u043B\u044F ${u.email}`);
        });
      }).addDropdown((dd) => {
        ...
        dd.onChange(async (v) => {
          u.role = v;
          await this.plugin.saveAccessJson(access);
          new import_obsidian4.Notice(`\u0420\u043E\u043B\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430 \u0434\u043B\u044F ${u.email}`);
        });
        return dd;
      }).addButton(
        (btn) => btn.setIcon("trash").setWarning().onClick(async () => {
          if (u.email === current.email) {
            new import_obsidian4.Notice("\u041D\u0435\u043B\u044C\u0437\u044F \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0441\u0430\u043C\u043E\u0433\u043E \u0441\u0435\u0431\u044F!");
            return;
          }
          access.users = access.users.filter((x) => x.email !== u.email);
          await this.plugin.saveAccessJson(access);
          new import_obsidian4.Notice(`\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C ${u.email} \u0443\u0434\u0430\u043B\u0451\u043D`);
          this.onOpen();
        })
      );
    });
    ...
    new import_obsidian4.Setting(containerEl).setName("Email").addText(
      (t) => t.setPlaceholder("user@\u2026").onChange((v) => newEmail = v.trim())
    );
    new import_obsidian4.Setting(containerEl).setName("\u041F\u0430\u0440\u043E\u043B\u044C").addText((t) => {
      t.setPlaceholder("\u041F\u0430\u0440\u043E\u043B\u044C");
      t.inputEl.type = "password";
      t.onChange((v) => newPassword = v);
    });
    new import_obsidian4.Setting(containerEl).setName("\u0420\u043E\u043B\u044C").addDropdown((dd) => {
      ["user", "admin"].forEach((r) => dd.addOption(r, r));
      dd.setValue(newRole);
    ...
    new import_obsidian4.Setting(containerEl).addButton(
      (btn) => btn.setButtonText("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F").setCta().onClick(async () => {
        if (!newEmail || !newPassword) {
          new import_obsidian4.Notice("Email \u0438 \u043F\u0430\u0440\u043E\u043B\u044C \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u044B");
          return;
        }
        if (access.users.some((u) => u.email === newEmail)) {
          new import_obsidian4.Notice("\u0422\u0430\u043A\u043E\u0439 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u0443\u0436\u0435 \u0435\u0441\u0442\u044C");
          return;
        }
        access.users.push({ email: newEmail, password: newPassword, role: newRole });
        await this.plugin.saveAccessJson(access);
        new import_obsidian4.Notice(`\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C ${newEmail} \u0441\u043E\u0437\u0434\u0430\u043D`);
        this.onOpen();
      })
    );
    ...
    let newGroupName = "";
    new import_obsidian4.Setting(containerEl).setName("\u0418\u043C\u044F \u0433\u0440\u0443\u043F\u043F\u044B").addText(
      (t) => t.setPlaceholder("\u0418\u043C\u044F \u0433\u0440\u0443\u043F\u043F\u044B").onChange((v) => newGroupName = v.trim())
    );
    new import_obsidian4.Setting(containerEl).addButton(
      (btn) => btn.setButtonText("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0433\u0440\u0443\u043F\u043F\u0443").setCta().onClick(async () => {
        if (!newGroupName) {
          new import_obsidian4.Notice("\u0418\u043C\u044F \u0433\u0440\u0443\u043F\u043F\u044B \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E");
          return;
        }
        if (access.groups.some((g) => g.name === newGroupName)) {
          new import_obsidian4.Notice("\u0422\u0430\u043A\u0430\u044F \u0433\u0440\u0443\u043F\u043F\u0430 \u0443\u0436\u0435 \u0435\u0441\u0442\u044C");
          return;
        }
        access.groups.push({ name: newGroupName, members: [], permissions: {} });
        await this.plugin.saveAccessJson(access);
        new import_obsidian4.Notice(`\u0413\u0440\u0443\u043F\u043F\u0430 "${newGroupName}" \u0441\u043E\u0437\u0434\u0430\u043D\u0430`);
        this.onOpen();
      })
    );
    ...
    new import_obsidian4.Setting(gitBox).setName("Git URL").addText(
      (t) => t.setPlaceholder("https://github.com/...").setValue(gitRepoUrl).onChange((v) => gitRepoUrl = v)
    );
    new import_obsidian4.Setting(gitBox).setName("\u0412\u0435\u0442\u043A\u0430").addText(
      (t) => t.setPlaceholder("main").setValue(gitBranch).onChange((v) => gitBranch = v)
    );
    new import_obsidian4.Setting(gitBox).setName("\u0422\u043E\u043A\u0435\u043D (\u043F\u043E \u0436\u0435\u043B\u0430\u043D\u0438\u044E)").addText(
      (t) => t.setPlaceholder("ghp_...").setValue(gitAuthToken).onChange((v) => gitAuthToken = v)
    );
    new import_obsidian4.Setting(gitBox).addButton(
      (btn) => btn.setButtonText("\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438").setCta().onClick(async () => {
        try {
          ...
          new import_obsidian4.Notice("Git-\u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u044B");
          await this.plugin.syncFromGit("pull");
        } catch (e) {
          new import_obsidian4.Notice("\u041E\u0448\u0438\u0431\u043A\u0430 git-\u0438\u043D\u0438\u0446\u0438\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u0438: " + (e?.toString() || e));
        }
      })
    ).addButton(
      (btn) => btn.setButtonText("\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043D\u043E\u0432\u044B\u0435 \u0444\u0430\u0439\u043B\u044B \u0432 Git").setCta().onClick(async () => {
        try {
          ...
          new import_obsidian4.Notice("\u041D\u043E\u0432\u044B\u0435 \u0444\u0430\u0439\u043B\u044B \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u044B \u0438 \u0437\u0430\u043F\u0443\u0448\u0435\u043D\u044B");
        } catch (e) {
          new import_obsidian4.Notice("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0438 \u0444\u0430\u0439\u043B\u043E\u0432: " + (e?.toString() || e));
        }
      })
    ).addButton(
  ...
  nodes.forEach((node) => {
    ...
    if (node.type === "folder") {
      ...
      select.onchange = async () => {
        ...
        new import_obsidian4.Notice(`\u041F\u0440\u0430\u0432\u0430 \u0434\u043B\u044F ${group.name} \u043D\u0430 ${node.path}: ${select.value}`);
      };
...
var UserView = class extends import_obsidian5.ItemView {
  constructor(leaf, plugin) {
    super(leaf);
    this.plugin = plugin;
  }
  ...
  async onOpen() {
    ...
    new import_obsidian5.Setting(wrapper).addButton(
      (btn) => btn.setButtonText("\u0412\u044B\u0439\u0442\u0438").setWarning().onClick(async () => {
        this.plugin.settings.currentUser = null;
        await this.plugin.saveSettings();
    ...
    let newPw = "";
    new import_obsidian5.Setting(wrapper).addText((t) => t.setPlaceholder("\u041D\u043E\u0432\u044B\u0439 \u043F\u0430\u0440\u043E\u043B\u044C").onChange((v) => newPw = v));
    new import_obsidian5.Setting(wrapper).addButton(
      (btn) => btn.setButtonText("\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C").setCta().onClick(async () => {
        if (!newPw) {
          new import_obsidian5.Notice("\u041F\u0430\u0440\u043E\u043B\u044C \u043D\u0435 \u043C\u043E\u0436\u0435\u0442 \u0431\u044B\u0442\u044C \u043F\u0443\u0441\u0442\u044B\u043C");
          return;
        }
        me.password = newPw;
        await this.plugin.saveAccessJson(access);
        new import_obsidian5.Notice("\u041F\u0430\u0440\u043E\u043B\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0451\u043D");
      })
    );
...
var LogModal = class extends import_obsidian6.Modal {
  ...
  async onOpen() {
    ...
    let filter = "";
    new import_obsidian6.Setting(containerEl).setName("\u0424\u0438\u043B\u044C\u0442\u0440 \u043F\u043E email \u0438\u043B\u0438 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044E").addText((t) => t.setPlaceholder("user@, action...").onChange((v) => {
...
var MyPlugin = class extends import_obsidian7.Plugin {
    ...
    this.addCommand({
      ...
      callback: async () => {
        if (this.settings.currentUser?.role === "admin") {
          ...
          new import_obsidian7.Notice("\u0414\u043E\u0441\u0442\u0443\u043F \u0437\u0430\u043F\u0440\u0435\u0449\u0451\u043D");
      }
    });
    this.addCommand({
      id: "git-pull",
  ...
  async doLogout() {
    ...
    new import_obsidian7.Notice("\u0412\u044B \u0432\u044B\u0448\u043B\u0438 \u0438\u0437 \u0441\u0438\u0441\u0442\u0435\u043C\u044B");
    this.app.workspace.detachLeavesOfType(ADMIN_VIEW_TYPE);
  ...
  async loadAccessJson() {
    ...
    await this.saveAccessJson(empty);
    return empty;
  }
  async saveAccessJson(d) {
    await safeCreateOrUpdateFile(this.app, "access.json", JSON.stringify(d, null, 2));
  }
  ...
  async syncFromGit(action) {
    ...
    if (!git.repoUrl) {
      new import_obsidian7.Notice("Git-\u0440\u0435\u043F\u043E\u0437\u0438\u0442\u043E\u0440\u0438\u0439 \u043D\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043D");
      return;
    }
    const vaultPath = this.app.vault.adapter.getBasePath();
    try {
    ...
    if (action === "pull") {
      try {
        ...
        new import_obsidian7.Notice("Git pull \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D!");
        await this.filterFilesByAccess();
      } catch (e) {
        new import_obsidian7.Notice("\u041E\u0448\u0438\u0431\u043A\u0430 pull: " + e.toString());
      }
    } else if (action === "push") {
      const access = await this.loadAccessJson();
      const user = this.settings.currentUser;
      if (!user) {
        new import_obsidian7.Notice("\u041D\u0435\u0442 \u0430\u0432\u0442\u043E\u0440\u0438\u0437\u0430\u0446\u0438\u0438 \u2014 push \u043D\u0435\u0432\u043E\u0437\u043C\u043E\u0436\u0435\u043D!");
        return;
      }
      const files = Array.from(getAllVaultFiles(this.app));
      let allowedFiles;
      if (user.role === "admin") {
        allowedFiles = files.filter(
          (f) => !f.endsWith("access.json") && !f.endsWith("events.json")
        );
      } else {
      ...
      if (allowedFiles.length === 0) {
        new import_obsidian7.Notice("\u041D\u0435\u0442 \u0444\u0430\u0439\u043B\u043E\u0432 \u0434\u043B\u044F \u043F\u0443\u0448\u0430");
        return;
      }
      ...
      try {
        ...
        new import_obsidian7.Notice("Git push \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D!");
      } catch (e) {
        new import_obsidian7.Notice("\u041E\u0448\u0438\u0431\u043A\u0430 push: " + e.toString());
      }
    }
  }
  // Новая функция для добавления неотслеживаемых файлов и пуша
    ...
    (0, import_child_process2.exec)(`cd "${vaultPath}" && git rev-parse --is-inside-work-tree`, (err, stdout, stderr) => {
      if (err) {
        (0, import_child_process2.exec)(`cd "${vaultPath}" && git init && git remote add origin ${remote} && git pull origin ${git.branch}`, (err2, stdout2, stderr2) => {
          if (err2) {
            new import_obsidian7.Notice("\u041E\u0448\u0438\u0431\u043A\u0430 \u0438\u043D\u0438\u0446\u0438\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u0438 Git: " + stderr2);
          } else {
            new import_obsidian7.Notice("Git-\u0440\u0435\u043F\u043E\u0437\u0438\u0442\u043E\u0440\u0438\u0439 \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0451\u043D!");
          }
        });
      }
    });
